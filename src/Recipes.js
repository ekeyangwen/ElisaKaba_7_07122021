export const recipes = [
  ...
  },
  {
    ...
    time: 80,
    description:
      "Découper le poulet en morceaux, les faire dorer dans une Cocotte avec de l'Huile d'olives. Salez et poivrez. Une fois doré, laisser cuire en ajoutant de l'eau. Au bout de 30 minutes, ajouter le coulis de Tomates, le Lait de coco ainsi que le poivron et l'oignon découpés en morceaux. Laisser cuisiner 30 minutes de plus. Servir avec du riz",
    appliance: "Cocotte",
    ustensils: ["Couteau"],
  },
  {
  ...
  },
  {
    ...
    time: 10,
    description:
      "Commencer par couper les feuilles de salade, ajouter les Tomates cerises et le fromage découpé en cubes ou en boules avec la Cuillère à melon. Découper le jambon de parme en fines lamelles. Ajouter la Pommes elle aussi découpée en petit morceaux. Assaisonnez à votre gout. ",
    appliance: "Saladier",
  ...
  },
  {
    ...
    time: 40,
    description:
      "Cuire les Pommes de terre environ 30 minutes. Découper les Echalottes finement. Durant la cuisson des Pommes de terre. Préparez la vinaigrette avec l'Huile d'olives et le vinaigre de cidre. Salez poivrez à discrétion. Dans un Saladier, mettre le mâche. Ajouter",
    appliance: "Casserole",
  ...
  },
  {
    ...
    time: 30,
    description:
      "Prendre les pois chiches, les mettre dans le mixer avec de l'Huile d'olives, ajouter le jus des 2 citrons et du paprika selon le gout.",
    appliance: "Mixer",
  ...
  },
  {
    ...
    time: 25,
    description:
      "Eplucher les patates douces et coupez les en morceaux. Les faire cuire durant 20 minute dans une Casserole d'eau bouillante. Passer au mixer en ajoutant la crème et l'Huile d'olives à son gout. Salez, poivrez. Pressez l'orange et ajouter le jus à l'ensemble. Servir.",
    appliance: "Mixer",
